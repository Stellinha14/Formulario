...
<html lang="pt-br">
	...
	<style>
		...
		.navbar{
			height: 65px;
			border-bottom: solid 4px #961f12;
		}
		.bg-body-tertiary{
			background-color: #d62e1c !important;
			font-family: basica;
		}
		.formu{
		...
		button{
			width: 43%;
			height: 30px;
			border: 2px solid #961f12;
			
		}
		.bord{
			border: 5px solid #961f12;
		}
		.ft{
			border: 5px solid #961f12;
		}
		...
		<div class="container d-flex align-items-center justify-content-center">
			<div class="row">
				...
				<div class="col-sm-12 col-md-6 align-items-center ">
					...
					<div class="ft mt-4 fd p-2 d-flex justify-content-center align-items-center text-center">
